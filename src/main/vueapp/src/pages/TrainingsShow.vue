  ...
  <div v-if="training" class="flex -mx-4">
    <div class="w-3/4 px-4">
      <div class="mb-8 flex justify-between items-center">
        <div>
          ...
          <span class="text-base text-grey-darker">{{ startDate.format('ddd D MMMM')}} &middot; {{ startDate.format('HH:mm') }} – {{ endDate.format('HH:mm') }} &middot; {{ training.location }}</span>
        </div>
        <router-link :to="{ name: 'trainings#edit', params: { id: $route.params.id } }" class="block no-underline px-4 py-2 text-grey border-grey-light hover:border-blue hover:bg-blue hover:text-white border-2 rounded">Edit</router-link>
      </div>
    ...
    <div class="w-1/4 px-4">
      ...
      <div class="flex flex-col justify-center items-center py-32">
        <svg class="w-16 h-16 stroke-current text-grey-light mb-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M16 16s-1.5-2-4-2-4 2-4 2"></path><line x1="9" y1="9" x2="9.01" y2="9"></line><line x1="15" y1="9" x2="15.01" y2="9"></line></svg>
