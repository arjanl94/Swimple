<template>
  <button @click="select(group)"
          :class="`${isSelected(group) ? 'bg-blue text-white border-blue' : 'bg-grey-lighter border-grey-lighter text-grey-dark'} border rounded-full overflow-hidden px-4 py-2 flex items-center mr-2`">
