<template>
  <div v-if="loaded" class="flex flex-no-wrap mb-6 overflow-x-scroll">
    ...
    <router-link v-if="showNewButton" :to="{ name: 'groups#new' }" class="flex items-center border rounded-full border-grey-light no-underline pl-3 pr-5 py-1 text-grey hover:bg-blue hover:border-blue hover:text-white">
